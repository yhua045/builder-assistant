// src/shared/infrastructure/storage/LocalDocumentStorageEngine.ts
import { DocumentStorageEngine, StoredFile } from '../../../shared/domain/services/DocumentStorageEngine.ts';
