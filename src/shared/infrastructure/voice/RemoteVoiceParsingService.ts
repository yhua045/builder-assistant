import { IVoiceParsingService, TaskDraft } from '../../application/ports/IVoiceParsingService';
import { ISTTAdapter } from '../../application/ports/ISTTAdapter';
import { ITranscriptParser } from '../../application/ports/ITranscriptParser';
