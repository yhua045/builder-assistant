import { DelayReasonType } from '../../../shared/domain/entities/DelayReason.ts';
import { DelayReasonTypeRepository } from '../../../shared/domain/repositories/DelayReasonTypeRepository.ts';
