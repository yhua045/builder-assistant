import { GetLocationOptions, GeoLocation } from '../../application/ports/IGpsService';
import { DeviceLocationProvider } from '../../../shared/application/usecases/location/GetBestLocationUseCase.ts';
