...
jest.mock('../../../components/StatusPriorityRow', () => ({
  StatusPriorityRow: () => null,
}));

jest.mock('../../../components/TaskDocumentSection', () => ({
  TaskDocumentSection: () => null,
}));

jest.mock('../../../components/TaskDependencySection', () => ({
  TaskDependencySection: () => null,
}));

jest.mock('../../../components/TaskSubcontractorSection', () => ({
  TaskSubcontractorSection: () => null,
}));

jest.mock('../../../components/TaskProgressSection', () => ({
  TaskProgressSection: () => null,
}));

jest.mock('../../../components/TaskQuotationSection', () => ({
  TaskQuotationSection: () => null,
}));

jest.mock('../../../components/AddDelayReasonModal', () => ({
  AddDelayReasonModal: () => null,
}));

jest.mock('../../../components/AddProgressLogModal', () => ({
  AddProgressLogModal: () => null,
}));

jest.mock('../../../screens/TaskPickerModal', () => ({
  TaskPickerModal: () => null,
}));

jest.mock('../../../components/SubcontractorPickerModal', () => ({
...
import type { TaskDetailsViewModel } from '../../../hooks/useTaskDetails';
