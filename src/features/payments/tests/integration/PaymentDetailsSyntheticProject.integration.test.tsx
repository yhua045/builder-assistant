...
jest.mock('tsyringe', () => {
  ...
  const { GetPaymentDetailsUseCase } = require('../../application/GetPaymentDetailsUseCase');
  const { MarkPaymentAsPaidUseCase } = require('../../application/MarkPaymentAsPaidUseCase');
  const { RecordPaymentUseCase } = require('../../application/RecordPaymentUseCase');
  const { AssignProjectToPaymentRecordUseCase } = require('../../application/AssignProjectToPaymentRecordUseCase');
...
jest.mock('../../components/PendingPaymentForm', () => ({
