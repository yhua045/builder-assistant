...
describe('ManualProjectEntry', () => {
  ...
  it('opens form and calls createProject on save', async () => {
    ...
    const form = root.findByType(require('../../../components/ManualProjectEntryForm').default);
    await act(async () => {
  ...
  it('transitions to CriticalPathPreview after successful createProject', async () => {
    ...
    const form = root.findByType(
      require('../../../components/ManualProjectEntryForm').default,
    );
    ...
    const { CriticalPathPreview } = require('../../../components/CriticalPathPreview/CriticalPathPreview');
