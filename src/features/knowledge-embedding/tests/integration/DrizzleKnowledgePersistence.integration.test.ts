...
import { DrizzleChunkRepository } from '../../document-processing/infrastructure/repositories/DrizzleChunkRepository';
...
import { KnowledgeChunkEntity } from '../../document-processing/domain/entities/KnowledgeChunk';
