...
// Mock the use cases
jest.mock('../../application/CreateQuotationUseCase');
jest.mock('../../application/ListQuotationsUseCase');
jest.mock('../../application/GetQuotationByIdUseCase');
jest.mock('../../application/UpdateQuotationUseCase');
jest.mock('../../application/DeleteQuotationUseCase');
