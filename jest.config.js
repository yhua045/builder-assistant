module.exports = {
  ...
  transformIgnorePatterns: [
    'node_modules/(?!(react-native|@react-native|@react-native-async-storage|@react-native-ml-kit|react-native-image-picker|react-native-audio-recorder-player|nativewind|react-native-css-interop|lucide-react-native)/)',
  ],
