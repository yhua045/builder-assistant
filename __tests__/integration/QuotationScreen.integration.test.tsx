...
import { IFilePickerAdapter } from '../../src/infrastructure/files/IFilePickerAdapter';
...
describe('QuotationScreen Integration', () => {
  ...
  it('auto-reference generation: createQuotation called with generated ref when reference left blank', async () => {
    ...
    jest.unmock('../../src/components/quotations/QuotationForm');
    ...
    const { QuotationEntity } = require('../../src/domain/entities/Quotation');
