...
import { useGlobalPaymentsScreen } from '../../src/hooks/useGlobalPaymentsScreen';
import type { PaymentWithProject } from '../../src/hooks/usePayments';
...
jest.mock('../../src/hooks/useGlobalQuotations', () => ({
  useGlobalQuotations: jest.fn(),
}));

jest.mock('../../src/application/usecases/payment/ListGlobalPaymentsUseCase');
